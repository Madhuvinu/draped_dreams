...
function Ol(e, t) {
	...
	const {
			...
			const w = () => {
				if (u.isMounted) {
					...
					(u.subTree = le),
						...
						G === null && Bl(u, le.el),
						j && be(j, _),
						(pe = C.props && C.props.onVnodeUpdated) && be(() => Fe(pe, B, C, X), _);
				} else {
					let C;
					...
					if ((X && be(X, _), !Ce && (C = j && j.onVnodeMounted))) {
						const _e = a;
						be(() => Fe(C, G, _e), _);
					}
		...
		Ue = (u, a, p, b, _, v, S, w, E) => {
			...
			x > F ? Ee(u, _, v, !0, !1, C) : Ie(a, p, b, _, v, S, w, E, C);
		},
		...
		De = (u, a, p, b, _ = null) => {
			...
			if (b !== 2 && x & 1 && w)
				if (b === 0) w.beforeEnter(v), s(v, a, p), be(() => w.enter(v), _);
				else {
...
let Jt = 1;
function wn(e, t = !1) {
	(Jt += e), e < 0 && xe && t && (xe.hasOnce = !0);
}
function jo(e) {
	return (e.dynamicChildren = Jt > 0 ? xe || Et : null), Kl(), Jt > 0 && xe && xe.push(e), e;
}
...
const Vo = ({ key: e }) => e ?? null,
	pn = ({ ref: e, ref_key: t, ref_for: n }) => (
		typeof e == "number" && (e = "" + e),
		e != null ? (ne(e) || fe(e) || H(e) ? { i: ve, r: e, k: t, f: !!n } : e) : null
	);
function Bo(e, t = null, n = null, s = 0, r = null, o = e === qe ? 0 : 1, i = !1, l = !1) {
	...
	return (
		...
		Jt > 0 && !i && xe && (c.patchFlag > 0 || o & 6) && c.patchFlag !== 32 && xe.push(c),
		c
	);
}
const me = kl;
function kl(e, t = null, n = null, s = 0, r = null, o = !1) {
	if (((!e || e === dl) && (e = ut), Sn(e))) {
		...
		return (
			n && Ls(l, n),
			Jt > 0 && !o && xe && (l.shapeFlag & 6 ? (xe[xe.indexOf(e)] = l) : xe.push(l)),
			(l.patchFlag = -2),
			l
		);
	}
...
const ju = [
	{ path: "/", redirect: "/home", name: "Home" },
	{
		path: "/home",
		name: "HomePage",
		component: () => we(() => import("./Home-0bee995f.js"), []),
	},
	{
		path: "/products",
		name: "Products",
		component: () => we(() => import("./Products-bd0a145f.js"), []),
	},
	{ path: "/cart", name: "Cart", component: () => we(() => import("./Cart-417bba79.js"), []) },
	{
		path: "/checkout",
		name: "Checkout",
		component: () => we(() => import("./Checkout-deaef2c7.js"), []),
	},
	{
		path: "/login",
		name: "Login",
		component: () => we(() => import("./Login-ac4644ce.js"), []),
	},
	{ path: "/admin", redirect: "/admin/dashboard", name: "Admin" },
	{
		path: "/admin/dashboard",
		name: "AdminDashboard",
		component: () => we(() => import("./Dashboard-88847396.js"), []),
	},
	{
		path: "/admin/products",
		name: "AdminProducts",
		component: () => we(() => import("./AdminProducts-64ddab8b.js"), []),
	},
	{
		path: "/admin/customers",
		name: "AdminCustomers",
		component: () => we(() => import("./Customers-001315bb.js"), []),
	},
	{
		path: "/admin/orders",
		name: "AdminOrders",
		component: () => we(() => import("./Orders-9a3ea49c.js"), []),
	},
	{
		path: "/admin/inventory",
		name: "AdminInventory",
		component: () => we(() => import("./Inventory-7d9c70ae.js"), []),
	},
	{
		path: "/admin/reports",
		name: "AdminReports",
		component: () => we(() => import("./Reports-0c057a25.js"), []),
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
