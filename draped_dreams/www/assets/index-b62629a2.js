...
const ju = [
	{ path: "/", redirect: "/home", name: "Home" },
	{
		path: "/home",
		name: "HomePage",
		component: () => be(() => import("./Home-314fa007.js"), []),
	},
	{
		path: "/products",
		name: "Products",
		component: () => be(() => import("./Products-ca49db57.js"), []),
	},
	{ path: "/cart", name: "Cart", component: () => be(() => import("./Cart-3b3897a2.js"), []) },
	{
		path: "/checkout",
		name: "Checkout",
		component: () => be(() => import("./Checkout-0d6c06ff.js"), []),
	},
	{
		path: "/login",
		name: "Login",
		component: () => be(() => import("./Login-96ed7baa.js"), []),
	},
	{
		path: "/register",
		name: "Register",
		component: () => be(() => import("./Register-531cd8d3.js"), []),
	},
	{ path: "/admin", redirect: "/admin/dashboard", name: "Admin" },
	{
		path: "/admin/dashboard",
		name: "AdminDashboard",
		component: () => be(() => import("./Dashboard-a5a8f84b.js"), []),
	},
	{
		path: "/admin/products",
		name: "AdminProducts",
		component: () => be(() => import("./AdminProducts-065bc58d.js"), []),
	},
	{
		path: "/admin/customers",
		name: "AdminCustomers",
		component: () => be(() => import("./Customers-05197754.js"), []),
	},
	{
		path: "/admin/orders",
		name: "AdminOrders",
		component: () => be(() => import("./Orders-27a62f90.js"), []),
	},
	{
		path: "/admin/inventory",
		name: "AdminInventory",
		component: () => be(() => import("./Inventory-58274dfe.js"), []),
	},
	{
		path: "/admin/reports",
		name: "AdminReports",
		component: () => be(() => import("./Reports-47ac8f51.js"), []),
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
