...
const ju = [
	{ path: "/", redirect: "/home", name: "Home" },
	{
		path: "/home",
		name: "HomePage",
		component: () => be(() => import("./Home-9d6d23f5.js"), []),
	},
	{
		path: "/products",
		name: "Products",
		component: () =>
			be(
				() => import("./Products-8207c5b1.js"),
				["assets/Products-8207c5b1.js", "assets/api-b634d5e6.js"]
			),
	},
	{ path: "/cart", name: "Cart", component: () => be(() => import("./Cart-7e88bd11.js"), []) },
	{
		path: "/checkout",
		name: "Checkout",
		component: () => be(() => import("./Checkout-7daef5b1.js"), []),
	},
	{
		path: "/login",
		name: "Login",
		component: () =>
			be(
				() => import("./Login-1273d9f0.js"),
				["assets/Login-1273d9f0.js", "assets/api-b634d5e6.js"]
			),
	},
	{
		path: "/register",
		...
		component: () =>
			be(
				() => import("./Register-0b384e44.js"),
				["assets/Register-0b384e44.js", "assets/api-b634d5e6.js"]
			),
	},
	{ path: "/admin", redirect: "/admin/dashboard", name: "Admin" },
	{
		...
		name: "AdminDashboard",
		component: () => be(() => import("./Dashboard-ac3578f7.js"), []),
	},
	{
		path: "/admin/products",
		name: "AdminProducts",
		component: () => be(() => import("./AdminProducts-339e1aef.js"), []),
	},
	{
		path: "/admin/customers",
		name: "AdminCustomers",
		component: () => be(() => import("./Customers-b63a88fc.js"), []),
	},
	{
		path: "/admin/orders",
		name: "AdminOrders",
		component: () => be(() => import("./Orders-abc0eb8a.js"), []),
	},
	{
		path: "/admin/inventory",
		name: "AdminInventory",
		component: () => be(() => import("./Inventory-dc2a38bc.js"), []),
	},
	{
		path: "/admin/reports",
		name: "AdminReports",
		component: () => be(() => import("./Reports-fd766c3d.js"), []),
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
