import {
	...
	i as C,
	j as S,
} from "./index-35e57a58.js";
const $ = { class: "min-h-screen bg-gray-50" },
	D = { class: "bg-white shadow-sm border-b" },
	N = { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" },
	j = { class: "flex justify-between items-center py-4" },
	B = { class: "flex items-center" },
	F = { class: "h-8 w-8 bg-purple-600 rounded-lg flex items-center justify-center mr-3" },
	I = { class: "flex items-center space-x-4" },
	P = { class: "bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16" },
								...
								e("div", L, [
									...
									i(
										a,
										{
											...
											onClick:
												t[3] ||
												(t[3] = (s) => o.$router.push("/products")),
										},
										{
											default: d(() => [
												...(t[8] || (t[8] = [p(" Shop Now ", -1)])),
											]),
											_: 1,
										}
									),
