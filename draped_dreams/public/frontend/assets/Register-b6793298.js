...
import { a as n, _ as w, c as u, b as _ } from "./FeatherIcon-82bdd98a.js";
const N = {
				...
				h = async () => {
					...
					try {
						...
						const r = await _.register({
							...
							email: a.value.email,
							phone: a.value.phone,
							user_password: a.value.password,
			...
			return (r, e) => (
				...
				c("div", N, [
					s("div", k, [
						s("div", null, [
							s("div", P, [
								l(u, { name: "user-plus", class: "h-6 w-6 text-purple-600" }),
							]),
							e[7] ||
								(e[7] = s(
									"h2",
									...
									s("div", null, [
										...
										l(
											n,
											{
												...
												"onUpdate:modelValue":
													e[5] ||
													(e[5] = (t) => (a.value.confirmPassword = t)),
											},
											null,
											8,
											["modelValue"]
