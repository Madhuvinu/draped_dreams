...
const z = { class: "min-h-screen bg-gray-50" },
	...
	Ee = { class: "text-sm text-gray-900" },
	Ie = { key: 0, class: "text-xs text-gray-500 line-through" },
	Le = { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900" },
	Ue = { class: "px-6 py-4 whitespace-nowrap" },
	...
	Ge = {
		...
		setup(He) {
			const r = g([]),
				...
				j = w(() => r.value.filter((o) => o.stock === 0).length),
				E = (o) => (o === 0 ? "danger" : o <= 10 ? "warning" : "success"),
				I = (o) => (o === 0 ? "Out of Stock" : o <= 10 ? "Low Stock" : "In Stock"),
				L = () => {
					const o = {
						id: Date.now(),
						name: i.value.name,
