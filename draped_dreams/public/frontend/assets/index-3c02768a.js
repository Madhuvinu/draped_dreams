...
const ju = [
	{ path: "/", redirect: "/home", name: "Home" },
	{
		path: "/home",
		name: "HomePage",
		component: () => be(() => import("./Home-2873ee6c.js"), []),
	},
	{
		path: "/products",
		name: "Products",
		component: () =>
			be(
				() => import("./Products-9439a6f7.js"),
				["assets/Products-9439a6f7.js", "assets/api-b634d5e6.js"]
			),
	},
	{ path: "/cart", name: "Cart", component: () => be(() => import("./Cart-4b367a5a.js"), []) },
	{
		path: "/checkout",
		name: "Checkout",
		component: () => be(() => import("./Checkout-2a2492ff.js"), []),
	},
	{
		path: "/login",
		name: "Login",
		component: () =>
			be(
				() => import("./Login-6ce4a9da.js"),
				["assets/Login-6ce4a9da.js", "assets/api-b634d5e6.js"]
			),
	},
	{
		path: "/register",
		...
		component: () =>
			be(
				() => import("./Register-f7534774.js"),
				["assets/Register-f7534774.js", "assets/api-b634d5e6.js"]
			),
	},
	{ path: "/admin", redirect: "/admin/dashboard", name: "Admin" },
	{
		...
		name: "AdminDashboard",
		component: () => be(() => import("./Dashboard-2404bc14.js"), []),
	},
	{
		path: "/admin/products",
		name: "AdminProducts",
		component: () => be(() => import("./AdminProducts-eae03b63.js"), []),
	},
	{
		path: "/admin/customers",
		name: "AdminCustomers",
		component: () => be(() => import("./Customers-a5d72197.js"), []),
	},
	{
		path: "/admin/orders",
		name: "AdminOrders",
		component: () => be(() => import("./Orders-411ee39e.js"), []),
	},
	{
		path: "/admin/inventory",
		name: "AdminInventory",
		component: () => be(() => import("./Inventory-c6d7e11f.js"), []),
	},
	{
		path: "/admin/reports",
		name: "AdminReports",
		component: () => be(() => import("./Reports-190eb9ef.js"), []),
	},
	{
		path: "/:pathMatch(.*)*",
		name: "NotFound",
