            ...
            <div class="p-6">
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  <div class="w-20 h-20 bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FeatherIcon name="image" class="w-8 h-8 text-purple-400" />
                  </div>
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center mt-1">
                      <span class="text-sm font-medium text-purple-600">₹{{ item.price }}</span>
                      <span v-if="item.originalPrice" class="text-xs text-gray-500 line-through ml-2">
                        ₹{{ item.originalPrice }}
                      </span>
                    </div>
                  </div>
              ...
              <div class="flex justify-between items-center mt-6 pt-6 border-t border-gray-200">
                ...
                <div class="text-sm text-gray-600">
                  Total: <span class="font-medium text-gray-900">₹{{ calculateCartTotal() }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow p-6 sticky top-8">
            ...
            <div class="text-center">
              ...
              <div class="flex justify-center space-x-2">
                <div class="w-8 h-5 bg-blue-100 rounded flex items-center justify-center">
                  <span class="text-xs font-bold text-blue-600">VISA</span>
                </div>
                <div class="w-8 h-5 bg-red-100 rounded flex items-center justify-center">
                  <span class="text-xs font-bold text-red-600">MC</span>
                </div>
                <div class="w-8 h-5 bg-green-100 rounded flex items-center justify-center">
