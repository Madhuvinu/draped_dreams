          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <TextInput v-model="shippingInfo.firstName" placeholder="Enter first name" required />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Last Name *</label>
                <TextInput v-model="shippingInfo.lastName" placeholder="Enter last name" required />
              </div>
              <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">Email *</label>
                <TextInput v-model="shippingInfo.email" type="email" placeholder="Enter email address" required />
              </div>
              <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">Phone Number *</label>
                <TextInput v-model="shippingInfo.phone" placeholder="Enter phone number" required />
              </div>
              <div class="md:col-span-2">
                <label class="block text-sm font-medium text-gray-700 mb-2">Address *</label>
                <TextInput v-model="shippingInfo.address" placeholder="Enter full address" required />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">City *</label>
                <TextInput v-model="shippingInfo.city" placeholder="Enter city" required />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Pincode *</label>
                <TextInput v-model="shippingInfo.pincode" placeholder="Enter pincode" required />
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">State *</label>
                <select v-model="shippingInfo.state" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
              <div 
                ...
                :class="{ 'border-purple-500 bg-purple-50': selectedPayment === method.id }"
              ...
              >
                ...
                <label :for="method.id" class="flex items-center cursor-pointer">
                  <div class="w-8 h-8 mr-3 flex items-center justify-center rounded"
                    :class="method.bgColor">
                    <span class="text-xs font-bold" :class="method.textColor">{{ method.shortName }}</span>
                  </div>
                  <div>
            ...
            <div class="space-y-3 mb-6">
              ...
              <div class="border-t border-gray-200 pt-3">
                <div class="flex justify-between text-base font-semibold">
                  ...
                  <span class="text-purple-600">₹{{ calculateGrandTotal() }}</span>
                </div>
              </div>
            </div>
