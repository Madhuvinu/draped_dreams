	...
	async register(userData) {
		try {
			...
			if (result.message && result.message.success) {
				...
				return {
					success: false,
					message: result.message?.message || "Registration failed",
				};
			}
		} catch (error) {
	...
	async getProducts(filters = {}) {
		try {
			...
			if (result.message && result.message.success) {
				...
				return {
					success: false,
					message: result.message?.message || "Failed to fetch products",
				};
			}
		} catch (error) {
	...
	async getProductDetails(productName) {
		try {
			...
			if (result.message && result.message.success) {
				...
				return {
					success: false,
					message: result.message?.message || "Failed to fetch product details",
				};
			}
		} catch (error) {
	...
	async getCategories() {
		try {
			...
			if (result.message && result.message.success) {
				...
				return {
					success: false,
					message: result.message?.message || "Failed to fetch categories",
				};
			}
		} catch (error) {
